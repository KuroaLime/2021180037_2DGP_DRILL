...
next_state = {
    AUTO_RUN: {RU:RUN, LU:RUN, RD:RUN, LD:RUN, OTD:RUN, OTU:AUTO_RUN, TIMER:AUTO_RUN},
    SLEEP: {RU:RUN, LU:RUN, RD:RUN, LD:RUN, OTD:AUTO_RUN, OTU:RUN, TIMER:SLEEP},
    IDLE: {RU: RUN, LU: RUN, RD: RUN, LD: RUN, OTD:AUTO_RUN, OTU:RUN, TIMER:SLEEP},
    RUN: {RU: IDLE, LU: IDLE, RD: IDLE, LD: IDLE, OTD:AUTO_RUN, OTU:IDLE, TIMER:RUN}
}
